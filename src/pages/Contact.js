...
export const Contact = () => {
  return (
    <div className="contact-page">
      <Helmet>
        <title>
          Contact | Lawyer Bucharest | Law and Insolvency Office Alina Marin
        </title>
        
        <meta
          name="description"
          content="Contact us for any legal issue you are facing. We offer consultation and representation in various legal fields. Location: Bucharest, Hours: Monday - Friday: 9 AM - 5 PM, Email: av_alinamarin@yahoo.com, Phone: +40769 935 716."
        />
      </Helmet>
      <section>
          ...
          <div className="row g-5">
            <div className="col-sm-6 order-sm-first ">
              <div className="contact-text d-flex flex-column ">
                ...
                <p>
                  We are here to offer our support in all the legal issues you
                  may be facing.
                </p>
                <p>
